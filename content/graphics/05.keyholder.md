...
::card{title="BOOTH販売ページ" icon="liria:booth" color="error" to="https://eicosapenta.booth.pm/items/4219339" target="\_blank"}
公開: 2022/10/05
::
...
lilToon, PhysBone設定済み。

## 内容

- UnityPackage
- プレハブ :badge{label="lilToon, PhysBone設定済"}
- モデル :badge{label="fbx"}
